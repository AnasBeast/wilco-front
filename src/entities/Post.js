...
export default class Post {
  ...
  addComment(comment) {
    const oldCommentIndex = this.comments.findIndex((oldComment) => oldComment.id === comment.id);
  ...
  static fromJSON(data) {
    ...
    const previewComments =
      data.first_comments && data.first_comments.map((commentJSON) => Comment.fromJSON(commentJSON));
