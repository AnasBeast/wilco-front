...
const HomeHeader = forwardRef(
  (
    {
      isHomePreferencesTooltipWasSeen,
        ...
        <View style={styles.headerContainer}>
          <View style={styles.headerLeftContainer}>
            <Pressable onPress={_onLogoPressed}>
              <Image resizeMode="contain" testID="logo-image" style={styles.logo} source={horizontalLogo} />
            </Pressable>
          </View>
          <View style={styles.headerRightContainer}>
            ...
            <Pressable onPress={onPreferencesButtonPressed} hitSlop={HIT_SLOP}>
              ...
              >
                <Image style={styles.rightLogo} source={sliders} />
              </Tooltip>
            </Pressable>
          </View>
        </View>
