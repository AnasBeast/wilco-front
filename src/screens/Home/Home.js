...
const Home = ({ testID, route }) => {
  ...
  const myFeedConditionalPlaceholder = () =>
    presenter.isFilterApplied ? (
      <Placeholder testID="placeholder-home-screen" />
    ) : (
      <MyFeedPlaceholder
  ...
  const myFeedPostList = () =>
    myFeedListPresenter.showPlaceholder ? (
  ...
  const isMyFeedsActiveTab = presenter.tabIndex === HOME_TABS.myFeed.index;
  ...
  return (
    <BaseScreen testID={testID} edgeTop>
      ...
      <View style={styles.tabsWrapper}>
        ...
        >
          <Tab.Item
            ...
            containerStyle={[styles.tabItemContainer, isMyFeedsActiveTab && styles.tabContainerActive]}
            titleStyle={[styles.tabItemTitle, isMyFeedsActiveTab ? styles.tabActive : styles.tabInactive]}
          />
          <Tab.Item
            ...
            containerStyle={[
              ...
              !isMyFeedsActiveTab && styles.tabContainerActive,
              { marginLeft: 'auto' },
            ]}
            titleStyle={[styles.tabItemTitle, !isMyFeedsActiveTab ? styles.tabActive : styles.tabInactive]}
          />
      ...
      >
        <TabView.Item style={styles.tabViewItemContainer} onMoveShouldSetResponder={_onMoveShouldSetResponder}>
          {myFeedPostList()}
        </TabView.Item>
